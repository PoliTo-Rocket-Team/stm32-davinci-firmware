 ...
 ***************************************************/
/* active information */
#define EXT_FLASH_PAGE_SIZE		0x0100		// 256 bytes 		page size (bytes)
#define EXT_FLASH_SECTOR_SIZE	0x1000		// 4 KB 			sector size (bytes)
#define EXT_FLASH_BLOCK_SIZE	0x00010000	// 64 KB 			block size (bytes)
#define EXT_FLASH_SIZE			0x01000000	// 16 MB (128 Mbit) total size (bytes)
#define EXT_FLASH_PAGE_NUM		0x10000		// 65536 			pages
