...
#define SPI1_DIO_SENSOR1_Pin GPIO_PIN_7
#define SPI1_DIO_SENSOR1_GPIO_Port GPIOA
#define IMU_1_CS_Pin GPIO_PIN_4
#define IMU_1_CS_GPIO_Port GPIOC
#define BARO_1_CS_Pin GPIO_PIN_5
#define BARO_1_CS_GPIO_Port GPIOC
...
#define IMU_2_CS_Pin GPIO_PIN_12
#define IMU_2_CS_GPIO_Port GPIOB
#define SPI2_SCK_SENSOR2_Pin GPIO_PIN_13
#define SPI2_SCK_SENSOR2_GPIO_Port GPIOB
#define BARO_2_CS_Pin GPIO_PIN_14
#define BARO_2_CS_GPIO_Port GPIOB
#define SPI2_DIO_SENSOR2_Pin GPIO_PIN_15
#define SPI2_DIO_SENSOR2_GPIO_Port GPIOB
#define DEBUG_UART_Pin GPIO_PIN_8
