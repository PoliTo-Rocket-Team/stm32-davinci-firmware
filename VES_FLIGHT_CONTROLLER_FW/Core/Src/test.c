...
void test_w25q128(W25Q128* flash) {
	...
	*/
	//XXX it is obvious since this is a nor flash, and therefore to reprogram the memory we need to perform an erase and fill the mem with all 1s
